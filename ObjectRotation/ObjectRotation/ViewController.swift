...
class ViewController: UIViewController {
    ...
    @IBAction func add(_ sender: Any) {
        ...
        // Rotate Pyramid around its x-axis
        // Euler Angles control a Nodes orientation i.e. pitch, yaw and roll
        // x: Roll, y: Pitch, z: Yaw
        // SCNVector3(x,y,z) in radians
        ...
        plane.position = SCNVector3(0,0.1,0)
        ...
        cylinder.position = SCNVector3(0.2,0.2,0.03)
